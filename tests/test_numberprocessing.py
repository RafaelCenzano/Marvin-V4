...
class BasicTestSuite(unittest.TestCase):
    ...
    def test_sig_fig_counter_for_four(self, value):
        self.assertEqual(
            physics.numberProcessing.count_sig_figs(value), 4)

    @params(9.8, 0, -9.8)
    def test_sig_fig_counter_for_90000(self, value):
        self.assertEqual(
            physics.numberProcessing.count_sig_figs(value), 90000)
    ...
    def test_check_value_int(self, value):
        self.assertTrue(physics.numberProcessing.checkValue(value))
    ...
    def test_check_value_strings(self, value):
        self.assertFalse(physics.numberProcessing.checkValue(value))

    def test_check_value_none(self):
        self.assertFalse(physics.numberProcessing.checkValue(None))
    ...
    def test_cleanup_num(self, value):
        self.assertEqual(
            physics.numberProcessing.cleanValue(value), int(value))

    def test_cleanup_num_none(self):
        self.assertEqual(
            physics.numberProcessing.cleanValue(None), None)
    ...
    def test_cleanup_form_integer(self, value):
        self.assertEqual(
            type(physics.numberProcessing.formCleanup(value)), type(5))
    ...
    def test_cleanup_form_none(self, value):
        self.assertEqual(
            physics.numberProcessing.formCleanup(value), None)
